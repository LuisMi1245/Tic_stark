...
<head>
    ...
    <link href="assets/css/mobile-480.css" rel="stylesheet">
    <link href="assets/css/mobile-320.css" rel="stylesheet">
...
<body>
    <main class="main_content">
        <!-- HEADER -->
        <header class="container-flex header-img-back nowrap-align-center" id="HEADER">

            <!-- LOGOTIPO -->
            <div class="col-item-flex-2">
                <figure class="header-logo">
                    <a href="#PORTADA">
                        <img class="img-full" id="img_header" src="assets/img/svg-images/logo-white.svg">
                    </a>
                </figure>
            </div>
        ...
        <section class="portada container-flex background-img-ticstark" id="PORTADA" alt="Fondo Ticstark">
        ...
        <section class="container-fluido">
            <div class="container-flex flexflow-r-pl">
        ...
        <section class="container-fluido background-color-ts-6" id="SERV">
            <div class="container-flex">
                <article class="col-item-flex-4">
                    <img class="img-full" src="assets/img/compreso/path-5.png" alt="servicios">
                </article>
        ...
        <section class="container-fluido background-white">
            <div class="container-flex">
                ...
                <article class="col-item-flex-4">
                    <img class="img-full" src="assets/img/compreso/path-6.png" alt="servicios">
                </article>
            </div>
        </section>
        ...
        <section class="container-fluido background-color-ts-7">
            <div class="container-flex">
                <article class="col-item-flex-4">
                    <img class="img-full" src="assets/img/compreso/path-7.png" alt="servicios">
                </article>
        ...
        <section class="container-fluido background-color-ts-8 blog sr6" id="BLOG">
            <article class="text-container">
                <h2 class="c-2 f-segoe-bn color-ticstark-black">BLOG</h2>
            </article>
            <div class="container-flex flexflow-r-ol fitems-spacearound">
                <article class="col-item-custom-2">
                    <div class="relative-container">
                        <div class="relative-categoria">
                            <span class="blog-header">Marca Personal</span>
                        </div>
                        <img class="relative-img" src="assets/img/compreso/path-2.png" alt="imagen del blog">
                        <div class="relative-categoria-2">
                            <span class="blog-cuerpo">Trabaja con nosotros, Marketing digital y software</span>
                        </div>
                    </div>
                </article>
                <article class="col-item-custom-2">
                    <div class="relative-container">
                        <div class="relative-categoria">
                            <span class="blog-header">Desafia tu mundo</span>
                        </div>
                        <img class="relative-img" src="assets/img/compreso/path-2.png" alt="imagen del blog">
                        <div class="relative-categoria-2">
                            <span class="blog-cuerpo">Trabaja con nosotros, Marketing digital y software</span>
                ...
                <article class="col-item-custom-2">
                    <div class="relative-container">
                        <div class="relative-categoria">
                            <span class="blog-header">Desarrolla</span>
                        </div>
                        <img class="relative-img" src="assets/img/compreso/path-2.png" alt="imagen del blog">
                        <div class="relative-categoria-2">
                            <span class="blog-cuerpo">Trabaja con nosotros, Marketing digital y software</span>
        ...
        <section class="container-fluido background-color-ts-9" id="CUSTOMER">
            <div class=" container-flex nowrap-align-center">
                <article class="col-item-flex-4 customer">
                    <h2 class="c-2 f-segoe-bn color-ticstark-white">CLIENTES</h2>
                </article>

                <div class="col-item-flex-8 customer">
                    <div class="container-flex flexflow-r-pl fitems-spacearound">
                        <article class="col-item-flex-2">
                            <img class="img-full" src="assets/img/svg-images/logo.png" alt="imagen cliente">
                        </article>
                        <article class="col-item-flex-2">
                            <img class="img-full" src="assets/img/svg-images/logo.png" alt="imagen cliente">
                        </article>
        ...
        <section class="container-fluido" id="FAQ">
            <div class="container-flex">
                            ...
                            <li>
                                <div class="container-flex icons">
                                    <div class="col-item-flex-2 subicons">
                                        <a href="https://www.facebook.com/ticstarksas/">
                                            <img class="img-full" src="assets/img/svg-images/facebook.svg" alt="logo facebook">
                                        </a>
                                    </div>
                                    <div class="col-item-flex-2 subicons">
                                        <a href="https://twitter.com/Ticstarksas">
                                            <img class="img-full" src="assets/img/svg-images/twitter.svg" alt="logo facebook">
                                        </a>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="col-item-flex-8 background-color-ts-7 sr4">
                    <h2 class="c-3 f-segoe-sl-webkit color-ticstark-6">ENVIANOS TU MENSAJE</h2>
